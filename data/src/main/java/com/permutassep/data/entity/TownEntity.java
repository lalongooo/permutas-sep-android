...
public class TownEntity implements Parcelable {
    ...
    public int describeContents() {
        return id + Integer.valueOf(municipioClave) + Integer.valueOf(estadoId);
    }
    ...
    class TownParcelableCreator implements Creator<TownEntity> {
        public TownEntity createFromParcel(Parcel source) {
            return new TownEntity(source);
        }
        public TownEntity[] newArray(int size) {
            return new TownEntity[size];
        }
    }

    public TownEntity(Parcel source) {
